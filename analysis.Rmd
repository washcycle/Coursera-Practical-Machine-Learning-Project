...
K-folds was used to do cross-validation. Ten folds were created and repeated 10 times for a total of 100 fold data sets to train and test each model against.
